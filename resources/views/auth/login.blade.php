                ...
                <div class="w-2/3 lg:w-1/5 mt-6">
                    <div class="max-w-md">
                        ...
                        <div class="flex border border-gray-300 rounded-md my-2">
                            <input type="text" id="naam" class="w-full px-4 py-2 bg-white border-l border-r border-gray-300 focus:outline-none" name="naam" id="email" autofocus required placeholder="Vul je email in...">
                        </div>
                    </div>
                </div>
